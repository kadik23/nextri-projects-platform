...
export const SKILLS_LEVELS: Option[] = [
  {
    label: "🔰 Beginner", // Already has emoji
    value: "beginner",
  },
  {
    label: "🚀 Intermediate", // Already has emoji
    value: "intermediate",
  },
  {
    label: "💼 Advanced", // Already has emoji
    value: "advanced",
  },
  {
    label: "🌟 Expert", // Already has emoji
    value: "expert",
  },
  {
    label: "🏆 Master", // Already has emoji
    value: "master",
  },
];
